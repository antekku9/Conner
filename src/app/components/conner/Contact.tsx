...
export function Contact() {
  return (
    <section id="kontakt" className="py-24" style={{ backgroundColor: 'var(--bg-light)' }}>
      <div className="max-w-[1200px] mx-auto px-5">
        <div className="text-center mb-12">
          <span style={{ color: 'var(--accent)' }} className="uppercase text-xs font-bold tracking-[2px]">
            Kontakt
          </span>
          <h2 className="text-4xl font-bold mt-2" style={{ color: 'var(--foreground)' }}>Skontaktuj się z nami</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div>
            ...
            }} className="rounded-2xl p-8 shadow-[0_10px_30px_rgba(0,0,0,0.05)] mb-6 border">
              <h3 className="text-2xl font-bold mb-6" style={{ color: 'var(--foreground)' }}>Conner Sp. z o.o.</h3>
              
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <MapPin style={{ color: 'var(--accent)' }} className="w-5 h-5 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-semibold mb-1" style={{ color: 'var(--foreground)' }}>Adres</p>
                    <p style={{ color: 'var(--text-muted)' }}>ul. Doktora Seweryna Sterlinga 27/29</p>
                    <p style={{ color: 'var(--text-muted)' }}>90-212 Łódź, Polska</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold mb-1" style={{ color: 'var(--foreground)' }}>Telefon</p>
