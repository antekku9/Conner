...
export default function SzkolyPage() {
  ...
  const benefits = [
    {
      ...
      description: 'Komputery, tablety i oprogramowanie w pełni dostosowane do potrzeb nowoczesnej edukacji.',
    },
    {
      icon: Shield,
      title: 'Bezpieczeństwo sieci',
      description: 'Zaawansowane systemy zabezpieczeń, ochrona danych RODO oraz kontrola dostępowa dla uczniów.',
    },
    {
      icon: Wrench,
      title: 'Serwis na miejscu',
      description: 'Błyskawiczna pomoc techniczna na terenie Łodzi, realizowana bez przerywania toku zajęć.',
    },
    {
      icon: Award,
      title: 'Ponad 28 lat doświadczenia',
      description: 'Wieloletnia, stabilna współpraca z dziesiątkami placówek oświatowych i urzędów.',
    },
  ];
  ...
  return (
    <div className="min-screen bg-[var(--background)] text-[var(--foreground)] transition-colors duration-300">
          ...
          <div className="flex items-center gap-12 lg:gap-16 flex-wrap">
            ...
            <div className="flex-1 min-w-[300px]">
              <ImageWithFallback
                ...
                className="w-full aspect-video md:aspect-auto object-cover rounded-2xl md:rounded-[20px] shadow-xl dark:shadow-2xl dark:shadow-black/40 border border-slate-100 dark:border-slate-800/60"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-[var(--background)]">
        <div className="max-w-[1200px] mx-auto px-5">
          <div className="bg-gradient-to-br from-[#1a1c20] to-[#2a2c30] dark:from-[#24272e] dark:to-[#1a1c20] text-white p-8 md:p-14 rounded-3xl border border-gray-800 shadow-2xl relative overflow-hidden">
            ...
            <div className="max-w-[700px] mx-auto text-center relative z-10">
              <GraduationCap className="w-14 h-14 text-[#c5a059] mx-auto mb-5" />
              <h2 className="text-2xl md:text-4xl font-black mb-4 text-white tracking-tight">
                Doświadczenie w zamówieniach publicznych
              </h2>
              <p className="text-sm text-gray-300 mb-8 leading-relaxed font-medium">
                Bezpiecznie realizujemy dostawy sprzętu w procedurach przetargowych. Doskonale znamy wymagania formalne, rygorystycznie przestrzegamy terminów realizacji oraz dostarczamy kompletną dokumentację, deklaracje zgodności i certyfikaty.
              </p>
              <div className="flex justify-center mb-8">
                <ul className="text-left inline-block space-y-3 text-sm font-semibold text-slate-200">
                  <li className="flex items-center gap-3">
                    <CheckCircle className="text-[#c5a059] w-5 h-5 flex-shrink-0" />
                    Pełna pomoc przy przygotowywaniu specyfikacji istotnych warunków zamówienia
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="text-[#c5a059] w-5 h-5 flex-shrink-0" />
                    Rygorystycznie dotrzymywane, gwarantowane terminy dostaw urządzeń
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="text-[#c5a059] w-5 h-5 flex-shrink-0" />
                    Komplet dokumentacji powykonawczej, atestów oraz certyfikatów CE
                  </li>
                </ul>
              </div>
              <div>
                <a 
                  href="#kontakt" 
                  className="bg-[#c5a059] text-white px-8 py-4 rounded-xl no-underline font-bold inline-block hover:bg-[#b39050] transition-colors shadow-lg"
                >
